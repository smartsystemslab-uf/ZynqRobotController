...
HD_PWD='/media/sf_Projects/ZynqRobotController/FPGA/Zynq_Robot_Controller/Zynq_Robot_Controller.tmp/AXI_PWM_Reader_8CH_v1_0_project/AXI_PWM_Reader_8CH_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_PWM_Reader_8CH_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_PWM_Reader_8CH_v1_0.tcl
